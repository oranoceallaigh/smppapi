...
/**
 * This class implements the common command-line parsing logic for all the
 * example classes.
 * 
 * All can be run with the following syntax: <br />
 * <code>java ExampleClass SmscHost:Port system_id password system_type
 * ton:npi:bind_address</code>
 * <br />
 * <table border="1">
 * <tr>
 * <th>SmscHost:Port
 * <td>The hostname (or ip address) and port of the SMSC to bind to. Example:
 * "10.0.0.33:5757"
 * 
 * <tr>
 * <th>system_id
 * <td>The value of the "system_id" field in the bind packet. To set as null,
 * simply pass the empty string: ''
 * 
 * <tr>
 * <th>password
 * <td>The value of the "password" field in the bind packet. To set as null,
 * simply pass the empty string: ''
 * 
 * <tr>
 * <th>system_type
 * <td>The value of the "system_type" field in the bind packet. To set as null,
 * simply pass the empty string: ''
 * 
 * <tr>
 * <th>ton:npi:bind_address
 * <td>The bind address to send in the bind packet. </table>
 * 
 * It is common that the last two arguments, system_type and bind_address, are
 * always null when binding to your SMSC as your account has default values
 * associated with them. If this is the case, it is sufficient to omit these
