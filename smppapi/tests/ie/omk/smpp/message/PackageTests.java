 ...
 * http://smppapi.sourceforge.net/ $Id: PackageTests.java,v 1.3 2002/11/11
 * 11:04:29 orank Exp $
 */
...
public class PackageTests {
    public static Test suite() {
        ...
        suite.addTest(new SizeTest("Empty fields test.") {
            public void runTest() {
                testMessageSizes(false);
            }
        });

        suite.addTest(new SizeTest("Filled fields test.") {
            public void runTest() {
                testMessageSizes(true);
            }
        });

        suite.addTestSuite(SMPPPacketTest.class);
