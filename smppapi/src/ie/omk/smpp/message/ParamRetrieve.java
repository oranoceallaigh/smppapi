...
// File identifier string: used for debug output
	private static String FILE = "ParamRetrieve";
	...
	public ParamRetrieve(InputStream in)
	{
		...
		{
			throw new SMPPException("Input stream does not contain a pararetrieve packet.");
		}
	}
	...
	public void writeTo(OutputStream out)
	{
		...
		catch(IOException x)
		{
			...
			throw new SMPPException("Error writing ParamRetrieve packet to OutputStream");
		}
	}
