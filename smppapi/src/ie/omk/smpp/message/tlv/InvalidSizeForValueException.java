 ...
 * bounds defined by its <code>Tag</code>. This can happen, for instance, when
 * an attempt is made to encode a string value that is longer than the maximum
 * length defined by the tag for that value.
 */
