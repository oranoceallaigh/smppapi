...
// File identifier string: used for debug output
	private static String FILE = "DeliverSMResp";
	...
	public DeliverSMResp(InputStream in)
	{
		...
		{
			Debug.d(this, "DeliverSMResp", "Input stream does not contain a deliver_sm_resp", Debug.DBG_1);
			throw new SMPPException("Input Stream does not contain a deliver_sm_resp packet");
		}
		catch(NumberFormatException x)
		{
			Debug.d(this, "DeliverSMResp", "Error reading message id from Input stream", Debug.DBG_1);
			throw new SMPPException("Error reading message Id from input stream");
		}
	...
	public void writeTo(OutputStream out)
	{
		...
		catch(IOException x)
		{
			...
			throw new SMPPException("Error writing deliver_sm_resp packet to output stream");
		}
	}
