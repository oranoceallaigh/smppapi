 ...
 * <code>Connection</code> object uses to call into this object will be blocked,
 * from the <code>Connection</code>'s point of view, until every observer has
...
public class SimpleEventDispatcher implements EventDispatcher {
    ...
    /** Get an iterator to iterate over the set of observers registered with
