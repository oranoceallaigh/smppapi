 ...
 * http://smppapi.sourceforge.net/ $Id: TestSMPPIO.java,v 1.3 2004/07/25
 * 12:08:01 orank Exp $
 */
...
public class TestSMPPIO extends TestCase {
    ...
    long[] longs1 = { 0x11L, 0x2211L, 0x332211L, 0x44332211L, 0x5544332211L,
            0x665544332211L, 0x77665544332211L, 0x8877665544332211L };

    long[] longs2 = { 0xe1L, 0xe2e1L, 0xe3e2e1L, 0xe4e3e2e1L, 0xe5e4e3e2e1L,
            0xe6e5e4e3e2e1L, 0xe7e6e5e4e3e2e1L, 0xe8e7e6e5e4e3e2e1L, };

    // Initialised in setUp.
    int[] ints1, ints2;

    byte[][] bytes1 = { { 0x11 }, { 0x22, 0x11 }, { 0x33, 0x22, 0x11 },
    ...
    public void testBytesToLong() {
        for (int i = 1; i < 8; i++) {
            String msg = "" + i + ":";
            assertEquals(msg + "1", longs1[i - 1], SMPPIO.bytesToLong(
                    bytes1[i - 1], 0, i));
            assertEquals(msg + "2", longs2[i - 1], SMPPIO.bytesToLong(
                    bytes2[i - 1], 0, i));
        }
    }
}