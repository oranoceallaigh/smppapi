 ...
 * http://smppapi.sourceforge.net/ $Id: TestSMPPDate.java,v 1.2 2004/07/25
 * 12:08:01 orank Exp $
 */
...
public class TestSMPPDate extends TestCase {
    ...
    protected void setUp() {
        ...
        r_testDate = new SMPPDate(r_years, r_months, r_days, r_hours,
                r_minutes, r_seconds);
    }
    ...
    public void testRelativeConstructor() {
        SMPPDate d = new SMPPDate(r_years, r_months, r_days, r_hours,
                r_minutes, r_seconds);
        assertTrue(d.isRelative());
        assertEquals("String compare", r_expectedDateString, d.toString());
        assertEquals("HashCode compare", r_expectedDateString.hashCode(), d
                .hashCode());
    }
    ...
    public void testParsing() {
        try {
            ...
            assertEquals("Absolute hashCode doesn't match", a_testDate
                    .hashCode(), d1.hashCode());

            assertEquals("Relative doesn't match", r_testDate, d2);
            assertEquals("Relative hashCode doesn't match", r_testDate
