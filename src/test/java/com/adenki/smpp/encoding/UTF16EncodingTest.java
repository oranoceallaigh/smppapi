...
@Test
public class UTF16EncodingTest extends BaseAlphabetEncodingTest<UTF16Encoding> {
    ...
    @Override
    protected UTF16Encoding getEncodingToTest() throws UnsupportedEncodingException {
