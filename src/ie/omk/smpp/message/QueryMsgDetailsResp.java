...
// File identifier string: used for debug output
	private static String FILE = "QueryMsgDetailsResp";
	...
	public QueryMsgDetailsResp(InputStream in)
	{
		...
		{
			throw new SMPPException("Input stream does not contain a query_msg_details_resp packet");
		}
	...
	public void setDestAddresses(SmeAddress d[])
	{
		...
		if(d == null || d.length < 1)
			throw new NullPointerException("QueryMsgDetailsResp: Destination table cannot be null or empty");
