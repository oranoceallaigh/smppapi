...
// File identifier string: used for debug output
	private static String FILE = "ReplaceSM";
	...
	public ReplaceSM(InputStream in)
	{
		...
		{
			throw new SMPPException("Input stream does not contain a replace_sm packet.");
		}
	}
	...
	public void writeTo(OutputStream out)
	{
		...
		{
			throw new SMPPException("Error writing replace_sm packet to output stream");
		}
	}
