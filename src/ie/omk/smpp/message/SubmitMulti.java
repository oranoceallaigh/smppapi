...
// File identifier string: used for debug output
	private static String FILE = "SubmitMulti";
	...
	public SubmitMulti(InputStream in)
	{
		...
		{
			throw new SMPPException("Input stream does not contain a submit_multi packet");
		}
	}
	...
	public void setDestAddresses(SmeAddress d[])
	{
		...
		if(d == null || d.length < 1)
			throw new NullPointerException("SubmitMulti: Destination table cannot be null or empty");
