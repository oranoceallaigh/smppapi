 ...
 * values.
 * <p>Optional parameter support in this API is based on using standard Java
 * types for parameter values. Therefore, where the SMPP specification defines a
 ...
 * types of values they encode.</p>
 * <center>
 * <table cols="3" border="1" width="90%">
 * <tr><th>SMPP type</th><th>Encoder</th><th>Java type</th></tr>
 * <tr>
 *   <td>Bit mask</td>
 *   <td>{@link BitmaskEncoder}</td><td>java.util.BitSet</td>
 * </tr>
 * <tr>
 *   <td>Integer</td>
 ...
 * <tr>
 *   <td>Octet string</td>
 *   <td>{@link OctetEncoder}</td><td>byte[]</td>
 * </tr>
 * <tr>
 *   <td>C-Octet string</td>
 *   <td>{@link StringEncoder}</td><td>java.lang.String</td>
 * </tr>
 * </table>
 * </center>
 * There is also one more encoder, {@link NullEncoder}, which is used in special
 * cases where a particular optional parameter has a tag but no value.
...
public interface Encoder {
     ...
     * @throws java.lang.ArrayIndexOutOfBoundsException if the encoding tries to
     * write beyond the end of the byte array.
     */
     ...
     * @throws java.lang.ArrayIndexOutOfBoundsException if the decoding tries to
     * read beyond the end of the byte array.
     */
