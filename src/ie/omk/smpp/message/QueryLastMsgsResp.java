...
// File identifier string: used for debug output
	private static String FILE = "QueryLastMsgsResp";
	...
	public QueryLastMsgsResp(InputStream in)
	{
		...
		{
			Debug.d(this, "<init>", "Input stream does not contain a query_last_msgs_resp", Debug.DBG_1);
			throw new SMPPException("Input stream does not contain a query_last_msgs_resp packet.");
		}
	}
	...
	public void writeTo(OutputStream out)
	{
		...
		catch(IOException x)
		{
			...
			throw new SMPPException("Error writing query_last_msgs_resp packet to output stream");
		}
	}
