 ...
 * an SmppConnection object. If an application wishes to use asynchronous
 * communications mode with the API framework, it will need to provide an
 * implementation of this interface to the SmppConnection to be notified of SMPP
 * events (such as packet reception).
 * @see SmppConnection#addObserver
 * @author Oran Kelly
 * @version 1.0
 */
public interface ConnectionObserver
{
     ...
     * @param source the SmppConnection which received the packet.
     * @param packet the SMPP packet received.
     */
    public void packetReceived(SmppConnection source, SMPPPacket packet);
     ...
     */
    public void update(SmppConnection source, SMPPEvent event);
}
