...
public interface SmscLink {
     ...
     * {@link ie.omk.smpp.UnsupportedOperationException}.
     * @return The current timeout, specified in milliseconds.
     * @throws ie.omk.smpp.UnsupportedOperationException If read timeouts
     * are not supported.
     * @see #setTimeout(int)
     */
    int getTimeout();
     ...
     * {@link ie.omk.smpp.UnsupportedOperationException}. A timeout value
